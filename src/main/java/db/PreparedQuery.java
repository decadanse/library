...
public class PreparedQuery {
    ...
    static final String SELECT_ALL_INFO = "SELECT * FROM Info";
    static final String INSERT_INFO = "INSERT INTO Info(info) VALUES (?)";
    static final String GET_LAST_ADDED_INFO = "SELECT * from Info WHERE id = (SELECT MAX(ID)  FROM Info)";
