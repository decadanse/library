...
//                } else ViewUtil.showConfirmation();//showStudentChoose(getSelectionItem()); //heres an ERROR; for test 1
                } else ViewUtil.showStudentChoose(getSelectionItem()); //heres an ERROR; what must be here; error in showStudentChoose
//                } else { //with getSelectionItem() everything fine
//                    Book k = getSelectionItem();
//                }
            }
        });
